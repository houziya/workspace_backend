...
function writeIframe()
{
    ...
    "    <td width=15 height=19 class=bg title='向前翻 1 月快捷键：←' style='cursor: hand' onclick='parent.prevM()'><b>&lt;</b></td>"+
    ...
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    "    <td width=15 class=bg title='向后翻 1 月快捷键：→' onclick='parent.nextM()' style='cursor: hand'><b>&gt;</b></td></tr></table>"+
    ...
    "    </td><td align=center><input name=today type=button value='Today' onfocus='this.blur()' style='width: 50' title='当前日期快捷键：T'"+
...
function returnDate() //根据日期格式等返回会员选定的日期
{
