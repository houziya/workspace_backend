...
</style><!-- BEGIN HEADER --><!--TOPERS START--><div class="header navbar navbar-inverse navbar-fixed-top"><!-- BEGIN TOP NAVIGATION BAR --><div class="navbar-inner"><div class="container-fluid"><!-- BEGIN LOGO --><a class="brand" href="index.php"><img src="__PUBLIC__/media/image/logo.png" alt="logo"/></a><!-- END LOGO --><!-- BEGIN RESPONSIVE MENU TOGGLER --><a href="javascript:;" class="btn-navbar collapsed" data-toggle="collapse" data-target=".nav-collapse"><img src="__PUBLIC__/media/image/menu-toggler.png" alt="" /></a><!-- END RESPONSIVE MENU TOGGLER --><!-- BEGIN TOP NAVIGATION MENU --><ul class="nav pull-right"><!-- BEGIN NOTIFICATION DROPDOWN --><!-- END NOTIFICATION DROPDOWN --><!-- BEGIN USER LOGIN DROPDOWN --><li class="dropdown user" style="margin-top: 4px;"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i><span class="username"><?php echo ($fck_rs['nickname']); ?></span><i class="icon-angle-down"></i></a><ul class="dropdown-menu"><li><a href="__APP__/Change/cody/c_id/1"><i class="icon-pencil"></i> 修改资料</a></li><li><a href="__APP__/Change/shenqing"><i class="icon-arrow-up"></i> 申请升级</a></li><li><a href="__APP__/Change/cody/c_id/2"><i class="icon-lock"></i> 修改密码</a></li><li><a href="__APP__/Change/cody/c_id/4"><i class="icon-envelope"></i> 我的激活码</a></li><li class="divider"></li><li><a href="__APP__/Public/LogOut/"  onclick="if(confirm('确定安全退出吗?')) return true; else return false;"><i class="icon-remove"></i> 安全退出</a></li></ul></li><!-- END USER LOGIN DROPDOWN --><!-- BEGIN account DROPDOWN --><li class="dropdown user account" style="margin-top: 4px;"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-tags"></i><span class="username">我的账户</span><i class="icon-angle-down"></i></a><ul class="dropdown-menu"><!--  <li><i class="icon-tag"></i> 静态钱包：<?php echo ($fck_rs['agent_cash']); ?></li><li><i class="icon-tag"></i> 动态钱包：<?php echo ($fck_rs['agent_use']); ?></li>--><li><a href="__APP__//Bonus/wallet" class="dropdown-toggle"><span class="username">钱包明细</span></a></li></ul></li><!-- END account DROPDOWN --><!-- BEGIN Language DROPDOWN--><li class="dropdown user language" style="margin-top: 4px;"><a href="__APP__/Tree/TreeAjax" class="dropdown-toggle"><i class="icon-globe"></i><span class="username">市场管理</span></a></li><!-- END Language DROPDOWN --></ul><!-- END TOP NAVIGATION MENU --></div></div><!-- END TOP NAVIGATION BAR --></div><!--TOPERS END//--><!-- END HEADER --><!-- BEGIN CONTAINER --><div class="page-container"><!-- BEGIN SIDEBAR --><!--SIDERBAR START-->   ﻿<div class="page-sidebar nav-collapse collapse"><!-- BEGIN SIDEBAR MENU --><ul class="page-sidebar-menu"><li><!-- BEGIN SIDEBAR TOGGLER BUTTON --><div class="sidebar-toggler hidden-phone"></div><!--  BEGIN SIDEBAR TOGGLER BUTTON --></li><li><!-- BEGIN RESPONSIVE QUICK SEARCH FORM --><div style="height: 15px;"></div><form class="sidebar-search" style="display: none;"><div class="input-box"><a href="javascript:;" class="remove"></a><input type="text" placeholder="Search..."/><input type="button" class="submit" value=" "/></div></form><!-- END RESPONSIVE QUICK SEARCH FORM --></li><li class="active"><a href="__APP__/Public/main"><i class="icon-home"></i><span class="title">系统首页 <span
...
return false;"><i class="icon-lock"></i><span class="title"><span class="label-en">Logout</span></span><span
                class=""></span></a></li></ul><!--  END SIDEBAR MENU --></div><!--TOPERS END//--><!-- END SIDEBAR --><!-- BEGIN PAGE --><div class="page-content"><!-- BEGIN PAGE CONTAINER--><div class="container-fluid"><div class="row-fluid"><div class="span12"><h3 class="page-title"> 门票转账 <small>My Homepage</small></h3><ul class="breadcrumb"><li><i class="icon-home"></i><a href="__APP__/Public/main">Home</a><i class="icon-angle-right"></i></li><li><a href="/index.php?s=/Change/FrontCode">我的门票</a></li></ul></div></div><div class="row-fluid"><div class="span12"><div class="portlet box grey"><div class="portlet-title"><div class="caption"><i class="icon-list"></i>门票转账 </div></div><table style="margin-left:10px; font-size:13px" width="90%" style="font-size:12px"><form method="post" action="__URL__/FrontCodesong"><tr height="10px"></tr><tr ><td align="right" width="60px"><span class="zc_hong">*</span>门票余额：</td><td><input name="tba" type="text" class="ipt" id="tba" onFocus="notice('14','')"  onblur="notice('14','none')"  value="<?php echo ($card_num); ?>" style="height:30px; text-align:center;" readonly /></td></tr><tr><td align="right" width="60px"><span class="zc_hong">*</span>转账门票数:</td><td><input name="num" type="text" id="UserID" class="form-control" style="height:30px; text-align:center;"  value="1"/></td></tr><tr><td align="right" width="60px"><span class="zc_hong">*</span> 对方帐号：</td><td><input name="Userto" type="text"  class="form-control" value="" style="height:30px; text-align:center;" /></td></tr><tr><td align="right" width="60px"><span class="zc_hong"></span></td><td><button type="submit" name="Submit"  class="btn green" onClick="if(confirm('确定要赠送给该账户吗？')) return true; else return false;"> 转 账 </button></td></tr><tr height="10px"></tr></form></table></div></div></div></div><!-- END PAGE CONTAINER--></div></div><!-- END PAGE --><!-- END CONTAINER --><!--FOOTERS START--><!-- BEGIN FOOTER --><div class="footer"><div class="footer-inner"> 2015 &copy;  </div><div class="footer-tools"><span class="go-top"><i class="icon-angle-up"></i></span></div></div><!-- END FOOTER --><!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) --><!-- BEGIN CORE PLUGINS --><script src="__PUBLIC__/media/js/jquery-1.10.1.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/jquery-migrate-1.2.1.min.js" type="text/javascript"></script><!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip --><script src="__PUBLIC__/media/js/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/bootstrap.min.js" type="text/javascript"></script><!--[if lt IE 9]><script src="__PUBLIC__/media/js/excanvas.min.js"></script><script src="__PUBLIC__/media/js/respond.min.js"></script><![endif]--><script src="__PUBLIC__/media/js/jquery.slimscroll.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/jquery.blockui.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/jquery.uniform.min.js" type="text/javascript" ></script><!-- END CORE PLUGINS --><!-- BEGIN PAGE LEVEL SCRIPTS --><script src="__PUBLIC__/media/js/app.js" type="text/javascript"></script><!-- END PAGE LEVEL SCRIPTS --><script>	jQuery(document).ready(function () {
