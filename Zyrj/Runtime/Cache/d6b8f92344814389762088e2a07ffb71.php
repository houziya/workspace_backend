...
return false;"><i class="icon-lock"></i><span class="title"><span class="label-en">Logout</span></span><span
                class=""></span></a></li></ul><!--  END SIDEBAR MENU --></div><!-- END SIDEBAR --><!-- BEGIN PAGE --><div class="page-content"><!-- BEGIN PAGE CONTAINER--><div class="container-fluid"><div class="row-fluid"><div class="span12"><h3 class="page-title"> 买入M包 <small>My Homepage</small></h3><ul class="breadcrumb"><li><i class="icon-home"></i><a href="__APP__/Public/main">Home</a><i class="icon-angle-right"></i></li></ul></div></div><div class="row-fluid"><div class="span12"><div class="portlet box"><div class="portlet-body "><form action="__APP__/Mavro/buyAC" method="post" class="form-horizontal" id="commenform"><!--
              <div class="control-group"><label class="control-label" for="">入场卷编码:<span class="required">*</span></label><div class="controls input-icon"><input name="zhucema" class="span3 m-wrap" id="zhucema" placeholder="输入入场卷编码" maxlength="12" ></div></div>                --><div class="control-group"><label class="control-label" for="">剩余门票<span class="required">*</span></label><div class="controls input-icon"><input type="text" class="span3 m-wrap" name="num" value="<?php echo ($card_num); ?>" disabled></div></div><div class="control-group"><label class="control-label" for="">买入金额 <span class="required">*</span></label><div class="controls input-icon"><select name="money" id="money" class="span3 m-wrap"><?php if(is_array($s2)): $i = 0; $__LIST__ = $s2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;消耗<?php echo ($vo/1000); ?>张门票</option><?php endforeach; endif; else: echo "" ;endif; ?></select></div></div><div class="control-group"><label class="control-label" for="">安全密码<span class="required">*</span></label><div class="controls input-icon"><input type="password" class="span3 m-wrap" name="password"></div></div><div align="left" class="pay_style"  style="display:none;">><label><input type="checkbox" value="0" name="pay_type[]" checked="checked">            银行支付</label><label><input type="checkbox" value="1" name="pay_type[]" checked="checked" >            支付宝支付</label><label><input type="checkbox" value="2" name="pay_type[]" checked="checked" >            微信支付</label><label><input type="checkbox" value="3" name="pay_type[]" checked="checked" >            财富通</label></div><div class="form-actions"><button type="submit" class="btn green" id="joinformsubbtn" onclick="if(confirm('确定要买入吗？')) return true; else return false;">确认买入 </button></div></form></div></div></div></div></div><!-- END PAGE CONTAINER--></div></div><!-- END PAGE --><!-- END CONTAINER --><!--FOOTERS START--><!-- BEGIN FOOTER --><div class="footer"><div class="footer-inner"> 2015 &copy; mmm.com </div><div class="footer-tools"><span class="go-top"><i class="icon-angle-up"></i></span></div></div><!-- END FOOTER --><!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) --><!-- BEGIN CORE PLUGINS --><script src="__PUBLIC__/media/js/jquery-1.10.1.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/jquery-migrate-1.2.1.min.js" type="text/javascript"></script><!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip --><script src="__PUBLIC__/media/js/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/bootstrap.min.js" type="text/javascript"></script><!--[if lt IE 9]><script src="__PUBLIC__/media/js/excanvas.min.js"></script><script src="__PUBLIC__/media/js/respond.min.js"></script><![endif]--><script src="__PUBLIC__/media/js/jquery.slimscroll.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/jquery.blockui.min.js" type="text/javascript"></script><script src="__PUBLIC__/media/js/jquery.uniform.min.js" type="text/javascript" ></script><!-- END CORE PLUGINS --><!-- BEGIN PAGE LEVEL SCRIPTS --><script src="__PUBLIC__/media/js/app.js" type="text/javascript"></script><!-- END PAGE LEVEL SCRIPTS --><script>	jQuery(document).ready(function () {
