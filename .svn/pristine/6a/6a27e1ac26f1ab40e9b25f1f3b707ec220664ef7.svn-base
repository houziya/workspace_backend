 ...
 * @version  $Id: common.php 2799 2012-03-05 07:18:06Z liu21st $
  +------------------------------------------------------------------------------
 */
function XTcheckInfo($id,$dates,$bian){
    ...
    if(empty($dates)){
        if (empty($_SESSION['LoginCheck'])){
            ...
            $content .= '\n\n';
            $content .= '在测试过程中,数据丢失或系统有变动,所造成的损失,公司概不负责。';
            $content .= '\n\n';
            ...
            $content .= '\n\n';
            $content .= '《紫云软件》感谢你对我们的支持，祝您使用软件愉快！';
            $content .= '\n\n';
            $content .= '您可登录网站：www.nnzy.net或拔打电话：0771-5605212进行咨询。';
            $content .= '\n\n';
            $content .= '=======================================';
            $url = __APP__.'/';
        ...
        if(empty($_SESSION['LoginCheckExpired']) && $datec<=$datex && $id==1){
            ...
            $content .= '\n\n';
            $content .= '可登录官方网站：www.nnzy.net或拔打电话：0771-5605212';
            $content .= '\n\n';
            $content .= '=========================================';
            $url = __APP__.'/';
